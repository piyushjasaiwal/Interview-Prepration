...
class Main {
  ...
  public static class LinkedList {
    ...
    public static LinkedList mergeSort(Node head, Node tail){
      ...
      while(second != tail && second.next != tail){// remember this part very important
        second = second.next.next;
        first = first.next;
      }
      
      LinkedList f = mergeSort(head, first);
      LinkedList s = mergeSort(first.next, tail);

      return mergeTwoSortedLists(f, s);
    }
  }
